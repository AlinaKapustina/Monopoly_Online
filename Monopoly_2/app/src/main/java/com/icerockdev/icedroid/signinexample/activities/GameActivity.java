...
import com.icerockdev.icedroid.signinexample.model.Player;
import com.icerockdev.icedroid.signinexample.model.Trade;
import com.icerockdev.icedroid.signinexample.utils.Client;
    ...
    private void updateView() {
        ...
        if (!dialogIsShow) {
            if (trade != null) {
                ...
                final TextView textView1 = new TextView(GameActivity.this);
